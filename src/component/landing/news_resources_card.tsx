        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col">
            <Link href="/news/zoom-friendly-edtech" className="group block h-full">
              ...
              {/* Article Title */}
              <h3 className="text-2xl md:text-[1.75rem] font-bold text-[#4D49DA] mb-4 leading-snug group-hover:text-[#41CCB5] transition-colors duration-300">
          ...
          <div className="flex flex-col justify-between gap-8 lg:gap-0 py-2">
            ...
            <Link href="/news/series-a-financing" className="flex flex-col sm:flex-row gap-6 md:gap-8 group">
              <div className="relative w-full sm:w-56 shrink-0 aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
                <Image 
                  src="/images/article_woman_laptop.png" 
              ...
              <div className="flex flex-col justify-center">
                <h4 className="text-xl font-bold text-[#4D49DA] mb-3 group-hover:text-[#41CCB5] transition-colors duration-300 leading-snug">
...
export default NewsAndResourcesSection;